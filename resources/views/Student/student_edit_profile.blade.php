...
<div class="row" style="vertical-align:middle;">
  ...
  <a class="btn btn-info" style="float:right;" href="{{url('student/dashboard')}}">View Profile</a>
...
<div class="row">
    ...
    <div class="text-center">
      ...
      <form role="form"  method="POST" enctype="multipart/form-data" action="{{url('student/editprofile_data')}}">
      @csrf
    ...
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-8">
          <input name="email" class="form-control" type="text" value="{{old('email', $student['email'])}}"/>
          @if($errors->has('email'))
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input name="contact_no" class="form-control" type="text" value="{{old('contact_no',$student['contact_no'])}}"/>
