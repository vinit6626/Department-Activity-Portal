...
<div class="row" style="vertical-align:middle;">
  <center><h3>New Attended Activity</h3></center>
...
<div class="row" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" method="POST" enctype="multipart/form-data" action="{{url('student/attended/activitydata')}}">
      @csrf
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input name="from_date" ng-model="from_date" class="form-control" type="date" ng-change="check_startdate(from_date)" required autofocus/>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input name="to_date" ng-model="to_date" class="form-control" type="date" ng-change="check_enddate(from_date,to_date)" required autofocus/>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="submit" class="btn btn-primary" ng-disabled="myForm.type.$invalid || myForm.topic.$invalid || myForm.place.$invalid || myForm.from_date.$invalid || myForm.to_date.$invalid || check_startdate(from_date) || check_enddate(from_date, to_date) || myForm.academic_year.$invalid || myForm.academic_semester.$invalid || fileInvalid" value="Submit">
          <span></span>
        </div>
      </div>
