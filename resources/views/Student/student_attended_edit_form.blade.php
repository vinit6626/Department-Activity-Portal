...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li><a href="{{url('student/show/attended/activities')}}"><b><span style="font-size:17px;">Activities Attended</span></b></a></li>
...
<div class="row" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" method="POST" enctype="multipart/form-data" action="{{url('student/edit/attended/activity/'.$activity['sr_no'])}}">
      @csrf
...
app.controller('myCtrl', function($scope) {
    ...
    $scope.topic="<?php echo (old('topic')!=''? old('topic'):$activity['topic']); ?>";
