...
<div ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" id="myForm" method="post" action="{{url('student/personal/all/reports/downloadAllExcel')}}">
        ...
        <div class="from_to_date">
            <div class="form-group col-md-3" style="margin-left: 5px;">
              <label class="control-label">From Date:</label>
                <input name="from_date" id="from_date" value="{{old('from_date')}}" ng-model="from_date" class="form-control" ng-change="check_enddate(from_date,to_date)" type="date" ng-disabled="month_and_year || (from_year || to_year) || academic_year || (activity=='Faculty_Published_Paper') || (activity=='Faculty_Published_Book')" autofocus/>
            </div>

            <div class="form-group col-md-3" style="margin-left: 5px;">
              <label class=" control-label">To Date:</label>
                <input name="to_date" ng-model="to_date" id="to_date" value="{{old('to_date')}}" class="form-control" type="date" ng-change="check_enddate(from_date,to_date)" ng-disabled="month_and_year || (from_year || to_year) || academic_year || (activity=='Faculty_Published_Paper') || (activity=='Faculty_Published_Book')" autofocus/>
...
$(document).ready(function(){
  ...
  $("#generate").click(function(){
      ...
      $.ajax({
        ...
        url:"{{url('student/generate/personal/reports')}}",
