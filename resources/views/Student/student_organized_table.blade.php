...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li class="active"><a href="#"><b><span style="font-size:17px;">Activities Organized</span></b></a></li>
</ul>
<br/>
...
;">
        ...
        <thead>
            <tr>
                ...
                <th style="padding-left: 10px;vertical-align:middle;">Title of Activity</th>
                <th style="padding-left: 10px;vertical-align:middle;">Role</th>
                <th style="padding-left: 10px;vertical-align:middle;">Coordinators</th>
                <th style="padding-left: 10px;vertical-align:middle;">Convener</th>
                ...
                <th style="padding-left: 10px;vertical-align:middle;">Resource Person/Industry</th>
                <th style="padding-left: 10px;vertical-align:middle;">Total no. of students</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{++$i}}</td>
                <td>{{$activity['type']}}</td>
                <td>{{$activity['title_of_activity']}}</td>
                <td>{{$activity['role']}}</td>
                <td>{{$activity['coordinators']}}</td>
                <td>{{$activity['convener']}}</td>
                ...
                <td>{{$activity['resource_person_or_industry']}}</td>
                <td>{{$activity['total_no_of_students']}}</td>
                <td>
                  @if($activity['file']=='')
                  <center>-</center>
                  @else
                ...
                <td><a href="{{url('student/edit/organized/activity/'.$activity['sr_no'])}}">Edit</a></td>
            </tr>
            @endforeach            
        </tbody>
    </table>
