...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li><a href="{{url('student/show/published/papers')}}"><b><span style="font-size:17px;">Published Papers</span></b></a></li>
...
<div class="row" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" method="POST" enctype="multipart/form-data" action="{{url('student/edit/published_paper/'.$activity['sr_no'])}}">
      @csrf
