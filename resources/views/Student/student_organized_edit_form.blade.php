...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li><a href="{{url('student/show/organized/activities')}}"><b><span style="font-size:17px;">Activities Organized</span></b></a></li>
...
<div class="row" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" method="POST" enctype="multipart/form-data" action="{{url('student/edit/organized/activity/'.$activity['sr_no'])}}">
      @csrf
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          ...
          <span style="color:red;" ng-show="myForm.role.$dirty && myForm.role.$invalid">
              <span ng-show="myForm.role.$error.required"><strong>Please enter role</strong>  
              </span>
          </span>
          @if($errors->has('role'))
          <span style="color:red;">
      ...
      <div class="form-group">
        ...
        <div class="col-md-1">
          @if($activity['file']!='')
          <a class="btn btn-warning" href="{{asset('activities/student/'.$activity['file'].'')}}" target="_blank">Old File</a>
          @endif
        </div>
      </div>
