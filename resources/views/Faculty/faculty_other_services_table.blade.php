...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li class="active"><a href="#"><b><span style="font-size:17px;">Services inside/outside institute</span></b></a></li>
</ul>
<br/>
...
;">
        ...
        <thead>
            <tr>
                ...
                <th style="padding-left: 10px;border-left:1px solid rgb(221, 221, 221);vertical-align:middle;">Title of contribution</center></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$activity['title_of_contribution']}}</td>
                ...
                <td><a href="{{url('faculty/edit/other_service/'.$activity['sr_no'])}}">Edit</a>
                </td>
            </tr>
            @endforeach            
        </tbody>
