...
<div class="row" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" id="myForm" method="POST" enctype="multipart/form-data" action="{{url('faculty/organized/activitydata')}}">
      {{csrf_field()}}
      <div class="form-group">
...
$(document).on('click','#submit_no_of_coordinators',function(){
  ...
  $.ajax({
    ...
    url:"{{url('faculty/organized/fetch/other_faculties')}}",
