...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li><a href="{{url('faculty/show/other_services/')}}"><b><span style="font-size:17px;">Services inside/outside institute</span></b></a></li>
...
<div class="row" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" method="POST" enctype="multipart/form-data" action="{{url('faculty/edit/other_service/'.$activity['sr_no'])}}">
      @csrf

      <div class="form-group">
        <label class="col-md-3 control-label">Title of Contribution:</label>
        <div class="col-md-8">
          <input name="title_of_contribution" ng-model="title_of_contribution" class="form-control" type="text"required autofocus/>

          <span style="color:red;" ng-show="myForm.title_of_contribution.$dirty && myForm.title_of_contribution.$invalid">
              <span ng-show="myForm.title_of_contribution.$error.required"><strong>Please enter title of contribution</strong>  
              </span>
          </span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="submit" class="btn btn-primary" ng-disabled="myForm.type.$invalid || myForm.title_of_contribution.$invalid || myForm.place.$invalid || myForm.role.$invalid || myForm.from_date.$invalid || myForm.to_date.$invalid || check_startdate(from_date) || check_enddate(from_date, to_date) || myForm.academic_year.$invalid || myForm.academic_semester.$invalid || fileInvalid" value="Submit">
          <span></span>
        </div>
      </div>
