...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li class="active"><a href="#"><b><span style="font-size:17px;">Research & Development</span></b></a></li>
</ul>
<br/>
...
;">
        ...
        <thead>
            <tr>
                ...
                <th style="padding-left: 10px;border-left:1px solid rgb(221, 221, 221);vertical-align:middle;">Approval Letter no.</center></th>
                <th style="padding-left: 10px;vertical-align:middle;">Description</th>
                <th style="padding-left: 10px;vertical-align:middle;">Funding agency</th>
                <th style="padding-left: 10px;vertical-align:middle;">Amount</th>
                <th style="padding-left: 10px;vertical-align:middle;">PI</th>                
                <th style="padding-left: 10px;vertical-align:middle;">CI</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{++$i}}</td>
                <td>{{$activity['approval_letter_no']}}</td>
                <td>{{$activity['description']}}</td>
                <td>{{$activity['funding_agency']}}</td>
                ...
                @endif
                <td><a href="{{url('faculty/edit/research_development/'.$activity['sr_no'])}}">Edit</a>
                </td>
