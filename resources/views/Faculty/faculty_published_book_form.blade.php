...
<div class="row" style="vertical-align:middle;">
  <center><h3>New Published Book</h3></center>
...
<div class="row" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" method="POST" enctype="multipart/form-data" action="{{url('faculty/published_book_data')}}">
      @csrf
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          ...
          <span style="color:red;" ng-show="myForm.authors.$dirty && myForm.authors.$invalid">
              <span ng-show="myForm.authors.$error.required"><strong>Please enter Authors </strong>
              </span>
...
app.controller('myCtrl', function($scope) {
    ...
    $scope.book_name="<?php echo old('book_name'); ?>";
    $scope.authors="<?php echo old('authors'); ?>";
    $scope.publication_house="<?php echo old('publication_house'); ?>";
