...
<div class="row" style="vertical-align:middle;">
  <center><h3>Service inside/outside institute</h3></center>
...
<div class="row" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" method="POST" enctype="multipart/form-data" action="{{url('faculty/other_services_data')}}">
      @csrf
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="submit" class="btn btn-primary" ng-disabled="myForm.type.$invalid || myForm.title_of_activity.$invalid || myForm.place.$invalid || myForm.role.$invalid || myForm.from_date.$invalid || myForm.to_date.$invalid || check_startdate(from_date) || check_enddate(from_date, to_date) || myForm.academic_year.$invalid || myForm.academic_semester.$invalid || fileInvalid" value="Submit">
          <span></span>
        </div>
      </div>
