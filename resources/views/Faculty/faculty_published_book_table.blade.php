...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li class="active"><a href="#"><b><span style="font-size:17px;">Published Books</span></b></a></li>
</ul>
<br/>
...
;">
        ...
        <thead>
            <tr>
                ...
                <th style="padding-left: 10px;border-left:1px solid rgb(221, 221, 221);vertical-align:middle;">ISBN</center></th>
                <th style="padding-left: 10px;vertical-align:middle;">Book Name</th>
                <th style="padding-left: 10px;vertical-align:middle;">Authors</th>
                <th style="padding-left: 10px;vertical-align:middle;">Publication House</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{++$i}}</td>
                <td>
                  <center>{{($activity['ISBN']=='')?'-':$activity['ISBN']}}</center>
                </td>
                <td>{{$activity['book_name']}}</td>
                <td>{{$activity['authors']}}</td>
                <td>{{$activity['publication_house']}}</td>
                ...
                <td><a href="{{url('faculty/edit/published_book/'.$activity['sr_no'])}}">Edit</a>
                </td>
            </tr>
            @endforeach            
        </tbody>
