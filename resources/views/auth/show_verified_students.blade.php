...
<ul class="nav nav-tabs" style="vertical-align:middle;margin-bottom:10px;margin-left:0px;">
    <li><a href="{{url('admin/show/students/unverified')}}"><span style="font-size:17px;">Unverified Accounts</span></b></a></li>
    <li class="active"><a href="#"><span style="font-size:17px;">Verified Accounts</span></a></li>
</ul>

@if(session()->has('student_unverified'))
<div class="alert alert-success alert-dismissible">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      {{session('student_unverified')}}
</div>
@endif
    ...
    <table id="example" class="display" class="table table-condensed" style="width:100%;margin-bottom: 20px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <form action="{{url('admin/student_make_unverified')}}" method="POST">
                @csrf
                <input type="hidden" name="unverify_student_id" value="{{$student['student_id']}}">
