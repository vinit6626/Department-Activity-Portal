...
<div class="row" style="vertical-align:middle;">
  <center><h3>Generate Students Reports</h3></center>
      ...
      <div class="row row1">      
        ...
        <div class="activity">
          <div class="form-group col-md-3" style="margin-left: 5px;">
            ...
            <select id="student_id"  ng-model="student_id" name="student_id" class="form-control" required>
        ...
        <div class="activity">
          <div class="form-group col-md-3" style="margin-left: 5px;">
            ...
            <select id="activity" ng-model="activity" name="activity" class="form-control{{ $errors->has('activity') ? ' is-invalid' : '' }}" required>
              <option value="all" selected>All</option>
              <option value="Student_Attended">Activities Attended</option>
              <option value="Student_Organized">Activities Organized</option>
              <option value="Student_Training_Internship">Training/Internship</option>
              <option value="Student_Published_Paper">Published Papers</option>
              </option>
            </select>
          </div>
        </div>
        ...
        <div class="from_to_date">
            <div class="form-group col-md-3" style="margin-left: 5px;">
              <label class="control-label">From Date:</label>
                <input name="from_date" id="from_date" value="{{old('from_date')}}" ng-model="from_date" class="form-control" ng-change="check_enddate(from_date,to_date)" type="date" ng-disabled="month_and_year || (from_year || to_year) || academic_year || (activity=='Student_Published_Paper')" autofocus/>
            </div>

            <div class="form-group col-md-3" style="margin-left: 5px;">
              <label class=" control-label">To Date:</label>
                <input name="to_date" ng-model="to_date" id="to_date" value="{{old('to_date')}}" class="form-control" type="date" ng-change="check_enddate(from_date,to_date)" ng-disabled="month_and_year || (from_year || to_year) || academic_year || (activity=='Student_Published_Paper')" autofocus/>
...
$(document).ready(function(){
  ...
  $("#generate").click(function(){
      ...
      var isStudentIdDisabled = $('#student_id').prop('disabled');
      if(isStudentIdDisabled==true){student_id='';}
      else{student_id = $('#student_id').val();}
      ...
      $.ajax({
        type:'POST',
        data:{student_id:student_id,activity:activity,type:type,from_date:from_date,to_date:to_date,academic_year:academic_year,academic_semester:academic_semester,month_and_year:month_and_year,year:year,from_year:from_year,to_year:to_year,_token:token},
        url:"{{url('admin/generate/students/reports')}}",
  ...
  $('#activity').change(function(){
    ...
    */
    if(activity=='Student_Attended' || activity=='Student_Organized')
    {
      $('.type').show();
