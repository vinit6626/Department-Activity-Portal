...
<div class="row" style="vertical-align:middle;">
  <center><h3>Generate Faculties Reports</h3></center>
...
<div ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="form-horizontal">
      <form name="myForm" id="myForm" method="post" action="{{url('admin/faculties/all/reports/downloadAllExcel')}}">
      ...
      <div class="row row1">      
        ...
        <div class="activity">
          <div class="form-group col-md-3" style="margin-left: 5px;">
            ...
            <select id="faculty_id"  ng-model="faculty_id" name="faculty_id" class="form-control" required>
                <option value="all" selected>All</option>
                @foreach($list_of_faculties as $faculty)
...
$(document).ready(function(){
  ...
  $("#generate").click(function(){
      ...
      var isFacultyIdDisabled = $('#faculty_id').prop('disabled');
      if(isFacultyIdDisabled==true){faculty_id='';}
      else{faculty_id = $('#faculty_id').val();}
      ...
      $.ajax({
        type:'POST',
        data:{faculty_id:faculty_id,activity:activity,type:type,from_date:from_date,to_date:to_date,academic_year:academic_year,academic_semester:academic_semester,month_and_year:month_and_year,year:year,from_year:from_year,to_year:to_year,_token:token},
        url:"{{url('admin/generate/faculties/reports')}}",
