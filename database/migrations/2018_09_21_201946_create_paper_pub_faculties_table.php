...
class CreatePaperPubFacultiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('paper_pub_faculties', function (Blueprint $table) {
            $table->increments('f_paper_id');
    ...
    {
        Schema::dropIfExists('paper_pub_faculties');
    }
}
